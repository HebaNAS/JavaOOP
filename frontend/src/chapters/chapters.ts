...
export const CHAPTERS: Chapter[] = [
  ...
  // ─── CHAPTER 7: Polymorphism ───
  {
    ...
    description: 'Override attack() in Mage so it behaves differently from Warrior. Call attack() on both a Warrior and a Mage to see polymorphism. Both bodies must reduce target.health — the game runs WHAT YOU WRITE, name-matching alone does nothing.',
    hints: [
      'Polymorphism means "many forms". Same method call (attack), different behaviour depending on the object\'s actual class.',
